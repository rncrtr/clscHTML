	...
	$(document).ready(function(){
		...
		$('input[id$=need-when]').focus(function(){if($(this).val() == 'when (this week, 5/23, etc.)'){$(this).val('');}});
		$('input[id$=need-where]').focus(function(){if($(this).val() == 'where (denver)'){$(this).val('');}});
		...
		$('input[id$=need-when]').blur(function(){if($(this).val() == ''){$(this).val('when (this week, 5/23, etc.)');}});
		$('input[id$=need-where]').blur(function(){if($(this).val() == ''){$(this).val('where (denver)');}});
